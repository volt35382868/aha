...
Zed_Vip = (8143774472, 8143774472)
Zed_Dev = (8143774472, 8143774472)
zchannel = {"@oonvo", "@qqvqqs"}
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://l.top4top.io/p_33374li4y1.jpg",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس جولد الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("GOLD𓅛", "https://t.me/OONVO"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
