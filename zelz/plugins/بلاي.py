...
# بلاي 
M = (
    "**𓆰**  𝙎𝙊𝙐𝙍𝘾𝙀 𝗚𝗢𝗟𝗗 ⌁   **العـاب الاونلايـن** 🎮𓆪 \n"
    "◐━─━─━─━─𝙕─━─━─━─━◐\n\n"
    ...
    "**𓄂-** 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 **⪼**  [𐇮 𝗩𝗢𝗟𝗧 آلـۘهہؚيـٰـُ͢ـُ໋۠بـ໋ۘ۠ه 𐇮](t.me/bdb0b)   \n"
    "**𓆰** 𝙎𝙊𝙐𝙍𝘾𝙀 𝗚𝗢𝗟𝗗 ⌁ **⪼**  [𝗚𝗢𝗟𝗗](https://t.me/oonvo)  "
)
...
@zedub.zed_cmd(
    ...
    info={
        "header": "العـاب الانـلاين لـ سـورس جــولد",
        "الاستـخـدام": "{tr}بلاي",
    },
)
