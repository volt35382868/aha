                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @i_y_i_d\
                                  \n\n--------بـدء تتبـع سجـل جولد --------\
                        ...
                        link = "[𐇮  الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/i_y_i_d)"
                        text = (
                            "**✘ تقـريـر اشعـار جولد  ✘**\n\n"
